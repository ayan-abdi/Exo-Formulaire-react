...
const Formulaire = (props) => {
    ...
    const [inputs, setInputs] = useState({ nom: '', description: '', priorite: arrayPriorites[0] });
    ...
    const handleSubmit = (e) => {
        ...
        setInputs({ nom: '', description: '', priorite: arrayPriorites[0] })
    };
        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <textarea name="description" cols="30" rows="10" value={description} onChange={handleChange} />
